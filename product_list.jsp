  ...
  <body style="text-align: center">
    ...
    <div class="header-top">
			<div class="wrap"> 
			 ...
			 <div class="cssmenu">
				<ul>
					<li><a href="new homepage.htm">Home</a></li> 
					<li class="active"><a href="login.html">Account</a></li> 
					<li><a href="checkout.html">Wishlist</a></li> 
					<li><a href="checkout.html">Checkout</a></li> 
					<li><a href="login.html">Log In</a></li> 
					<li><a href="RegisterPage.html">Sign Up</a></li> 
					<li><form action="product_list.html" method="get"><input type="text" name="search" class="search1">
						<input type="submit" class="btn1" value="Search"></form>
					</li>
				</ul>
			</div>
			<div class="clear"></div>
...
-->
	...
	<div class="div1">
		<div class="div2">
			<span><div id="itemNo" name="itemNo" style="display:inline-block;">1-7</div> of <div id="itemnum" name="itemnum" style="display:inline-block;">9</div> results for <font style="color:red;">"computer"</font> </span><!--之后改成变量-->
		</div>
		<div class="div3">
			<ul>
			...
			<ul>
				<li><span/></li>
				<li style="font-size:18px; font-weight:bold; text-align:left; margin-left:25px;">Condition</li>
				<li><span class="span2"/></li>
			</ul>
			<ul style="margin-left:25px;">
				<li><a href="new homepage.htm">New</a></li>
				<li><a href="new homepage.htm">Used</a></li>
				<li><span class="span1"/></li>
			</ul>
			<ul>
				<li><span/></li>
				<li style="font-size:18px; font-weight:bold;text-align:left; margin-left:25px;">Rateing</li>
				<li><span class="span2"/></li>
			</ul>
			<ul style="margin-left:25px;">
				<li><a href="new homepage.htm"><img width=15px src="./img/product_list/star.png"><img  width=15px src="./img/product_list/star.png"><img width=15px src="./img/product_list/star.png"><img width=15px src="./img/product_list/star.png"><img width=15px src="./img/product_list/bullet-grey.png"> & up</a></li>
				<li><a href="new homepage.htm"><img width=15px src="./img/product_list/star.png"><img width=15px src="./img/product_list/star.png"><img width=15px src="./img/product_list/star.png"><img width=15px src="./img/product_list/bullet-grey.png"><img width=15px src="./img/product_list/bullet-grey.png"> & up</a></li>
				<li><a href="new homepage.htm"><img width=15px src="./img/product_list/star.png"><img width=15px src="./img/product_list/star.png"><img width=15px src="./img/product_list/bullet-grey.png"><img width=15px src="./img/product_list/bullet-grey.png"><img width=15px src="./img/product_list/bullet-grey.png"> & up</a></li>
				<li><a href="new homepage.htm"><img width=15px src="./img/product_list/star.png"><img width=15px src="./img/product_list/bullet-grey.png"><img width=15px src="./img/product_list/bullet-grey.png"><img width=15px src="./img/product_list/bullet-grey.png"><img width=15px src="./img/product_list/bullet-grey.png"> & up</a></li>
				<li><span class="span1"/></li>
			</ul>
		</div>
		...
		<div class="div4">
			<span style="display:block;text-align:left; width:1000px; height:25px; border-bottom:1px #CCCCCC solid; margin:2px 0 0 30px">
			Relative Search: <a href="new homepage.htm">Laptop</a>, <a href="new homepage.htm">Computer Desk</a> </span>
			
				<% 
				for(Products p : list){
		 %>
		<div id="listitem<%=id++ %>" style="margin-top:0px; border-top:5px #F2F2F2 solid">
				<img src=<%=p.getImg() %> width="128" height="128"/>
				<div class="div1">
				<span id="span1">
				<a href="product.jsp?pname=<%=p.getProduct_name() %>"><%=p.getProduct_name() %></a>
				...
				<span id="span3"><a href="personal page.htm">Provided by <%=name %></a></span>
				</div>
				<span></span>
			</div>
        ...
        <div class="footer-top">
            <div class="wrap">
                <div class="section group example">
                    ...
                    <div class="col_1_of_2 span_1_of_2">
                        <ul class="f-list">
                            <li><img src="./images/3.png"><span class="f-text">Call us! 000-000-0000 </span><div class="clear"></div></li>
                        </ul>
                    </div>
                    <div class="clear"></div>
                </div>
